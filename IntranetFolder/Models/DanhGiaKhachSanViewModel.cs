...
{
    public class DanhGiaKhachSanViewModel
    {
        public IEnumerable<DanhGiaKhachSanDTO> DanhGiaKhachSanDTOs { get; set; }
        public DanhGiaKhachSanDTO DanhGiaKhachSanDTO { get; set; }
